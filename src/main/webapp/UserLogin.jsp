...
<Body background="voting.jpg" width=100%;>  
<body>  
    <center> <h1 style="color:white;"><b> USER LOGIN FORM </b></h1> </center> 
    <form action="UserLogin" method="post">
        <div class="container"> 
            ...
            <center><a href="register.jsp">New user register here...</a></center>
